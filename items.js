...
function ItemDAO(database) {
    ...
    this.getCategories = function(callback) {
        ...
        */
        ...
        this.db.collection('item').aggregate( query ).toArray( (err, data) => {
    ...
    this.getItems = function(category, page, itemsPerPage, callback) {
        ...
        */
        ...
        let queryConfig = category === 'All' ? {} : query;

        let sortConfig = {
          _id: 1
        }

        this.db.collection('item').find( queryConfig ).sort( sortConfig ).skip( page * itemsPerPage ).limit(itemsPerPage).toArray( (err, data) => {
          assert.equal(null, err);
    ...
    this.getNumItems = function(category, callback) {
         ...
         */
         ...
         /*this.db.collection('item').find( queryConfig ).count()
          ...
          // Con async-await:
          async function test() {
            let count = await this.db.collection('item').find( queryConfig ).count();
    ...
    this.getNumSearchItems = function(query, callback) {
        ...
        */
        ...
        // Con async-await:
        async function test() {
          let numItems = await this.db.collection('item').find( queryConfig ).count();
